...
This project contains the source code for a very simple realtime comments widget application with sentiments. With sentiment analysis, we are able to detect the mood of a person based on the words they use in their comments. Here is a screenshot of the application.
